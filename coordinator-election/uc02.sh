...
curl "http://localhost:8002?cmd=caste&PId=2&Coordinator=1&CId=3&HCId=3&SingleIP=2"
curl "http://localhost:8003?cmd=caste&PId=3&Coordinator=1&CId=3&HCId=3&SingleIP=2"
